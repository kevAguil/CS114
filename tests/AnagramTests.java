...
FileWriter(DICTIONARY_FILE));
    ...
    public void SingleMostAnagramsForHashMapTest() {
        String [] words = new String [] {"marsipobranchiata", "maple", "dice", 
"basiparachromatin"};
        createDictionary(words);
        AnagramFinderHashTableImpl impl = new AnagramFinderHashTableImpl();
        try {
            ...
            assertEquals(true, equals(words1, new String [] 
{"marsipobranchiata","basiparachromatin" }));
            totalScore += 4;
...
{"marsipobranchiata","basiparachromatin" }));
    ...
    public void multiAnagramsForHashMapTest() {
        String [] words = new String [] {"alerting", "alter", "altering", 
"integral","maple",
                                      "post", "apers", "pears",
                                      "pots", "spot", "stop", "tops",
                         "keats", "relating", "skate", "stake", "steak", 
"triangle", "takes"};
        createDictionary(words);
        AnagramFinderHashTableImpl impl = new AnagramFinderHashTableImpl();
        try {
            ...
            totalScore += 4;
            String [] wordGroup2 = {"alerting", "altering", "integral", "relating",
"triangle"};
...
"integral","maple",
                "post", "apers", "pears",
                "pots", "spot", "stop", "tops",
                "keats", "relating", "skate", "stake", "steak", "triangle", 
"takes"};
        createDictionary(words);
        AnagramFinderListImpl impl = new AnagramFinderListImpl();
        try {
